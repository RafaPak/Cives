...
class CustomDrawerEmp extends StatelessWidget {
  final PageController pageController;
  CustomDrawerEmp(this.pageController);
        ...
        children: <Widget>[
          ...
          ListView(
            ...
            children: <Widget>[
              ...
              buildInkWell(
                  Icons.info_outline, "Status", context, pageController, 2),
              buildInkWell(
                  Icons.business, "Empresa", context, pageController, 3),
              InkWell(
                onTap: () {
                  Navigator.push(
